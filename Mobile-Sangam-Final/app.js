...
const MS = (() => {
  ...
  const renderReport = (calc, adv) => {
    ...
    const block = `
      <div class="ms-report p-4 rounded-xl shadow">
        ...
        <div class="my-3">${renderHarmonyRing(calc.harmonyScore)}</div>
        <div class="text-center text-sm mb-4">Harmony Score</div>
        <div class="p-3 rounded border mb-3">
          <div class="font-semibold mb-2">${S.lang === 'hi' ? 'सार सलाह (Small Advice)' : 'Small Advice'}</div>
          <div>${adv.small}</div>
        </div>
        <div class="p-3 rounded border mb-3">
          <div class="font-semibold mb-2">${S.lang === 'hi' ? 'विस्तृत सलाह (Big Advice)' : 'Big Advice'}</div>
          <div>${adv.big}</div>
        </div>
        <div class="p-3 rounded border">
          <div class="font-semibold mb-2">${S.lang === 'hi' ? 'उपाय (Remedies)' : 'Remedies'}</div>
          <div>${adv.remedy}</div>
        </div>
